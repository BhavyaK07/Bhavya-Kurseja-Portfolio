...
const Sidebar: React.FC<SidebarProps> = () => {
  ...
  return (
    <div className="fixed left-0 top-0 h-screen w-[300px] bg-transparent px-4 py-4 flex flex-col justify-between" style={{zIndex: 10}}>
      <div>
        {/* Profile Picture */}
        <div className="flex flex-col items-center mb-5 mt-8 relative" style={{marginTop: '40px'}}>
          ...
          <div className="w-full mt-3 p-3 rounded-lg bg-dark-bg/70 backdrop-blur-sm">
            ...
            <p className="mt-3 text-sm leading-relaxed text-gray-400 text-center">
